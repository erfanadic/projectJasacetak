...
public class Laporan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Laporan Data Produk");
        ...
        jButton2.setText("Laporan Data Transaksi");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream
                ("lapProduk.jasper"), null, Konek.getKoneksi());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
            JasperPrint jp = JasperFillManager.fillReport(getClass().getResourceAsStream
                ("lapTransaksi.jasper"), null, Konek.getKoneksi());
            JasperViewer.viewReport(jp, false);
        } catch(Exception e) {
            JOptionPane.showMessageDialog(rootPane, e);
        }       // TODO add your handling code here:
