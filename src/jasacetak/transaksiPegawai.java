...
public class transaksiPegawai extends javax.swing.JFrame {
//membuat objek    
    private DefaultTableModel model;
    
    //deklarasi variabel
    String noJual, nmProduk, nmPelanggan, Alamat, Tanggal;
    int  jumlahBayar ;
    double Harga, jumlahBeli, Total,Kembali;
    /**
     * Creates new form transaksiPegawai
     */
    ...
    public void dataSelect(){
        ...
        txtJumlahbeli.setText(""+model.getValueAt(i,3));
        txtTotal.setText(""+model.getValueAt(i,4));
        txtJumlahbayar.setText(""+model.getValueAt(i,5));
        txtKembali.setText(""+model.getValueAt(i,6));
        txtNMpelanggan.setText(""+model.getValueAt(i,7));
        txtAlamat.setText(""+model.getValueAt(i,8));
        txtTanggal.setText(""+model.getValueAt(i,9));
    }
public void jumlah(){
    ...
    private void initComponents() {
        ...
        cmdReset1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        cmdReset1.setText("CETAK");
...
try {
        String path="src/jasacetak/Cetak.jasper";
         HashMap parameter = new HashMap();
        parameter.put("no_jual",txtNojual.getText());
        
JasperPrint print=
JasperFillManager.fillReport(path,parameter,Konek.getKoneksi());
JasperViewer.viewReport(print,false);
}catch(Exception ex){
    JOptionPane.showMessageDialog(rootPane,"tidak ada"+ex);
}// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transaksiPegawai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
